            ...
            <v-row justify="center" class="h-100" align="center">
                <v-col cols="12" lg="4" md="5">
                    <v-card elevation="3">
                        ...
                        <v-card-text>
                            <v-text-field clearable hide-details="auto" class="mb-3" label="First Name" v-model="firstName" variant="outlined"></v-text-field>
                            <v-text-field clearable hide-details="auto" class="mb-3" label ="Last Name" v-model="lastName" variant="outlined"></v-text-field>
                            <v-text-field clearable hide-details="auto" class="mb-3" label ="Email" v-model="email" variant="outlined"></v-text-field>
                            <v-text-field clearable hide-details="auto" class="mb-3" label ="Address" v-model="address" variant="outlined"></v-text-field>
