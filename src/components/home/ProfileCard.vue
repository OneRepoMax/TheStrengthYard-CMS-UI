  ...
  <v-card elevation="3" class="mb-3">
    ...
    <div class="mx-3 mb-3">
      ...
      <v-card-text>
        ...
        <v-btn class="me-3 mb-3 text-capitalize" x-large :color="activeTab === 'ManageMembership' ? 'teal' : ''" rounded
      ...
      <v-main>
        ...
        <v-container>
          <v-row>
            ...
            <MakePayment :membershipList="displayedMembership" :is="currentComponent"
              v-if="currentComponent === 'MakePayment'" />
          </v-row>
        </v-container>
        <v-container>
          <ManageMembership :membershipRecordList="displayedMembershipRecord" :is="currentComponent"
